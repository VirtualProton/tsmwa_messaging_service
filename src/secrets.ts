...
export const WELCOME_TEMPLATE_ID = process.env.WELCOME_TEMPLATE_ID!;

export const NEW_USER_TEMPLATE_ID = process.env.NEW_USER_TEMPLATE_ID!;

export const BILL_GENERATED_TEMPLATE_ID = process.env.BILL_GENERATED_TEMPLATE_ID!;

export const PARTIAL_PAYMENT_TEMPLATE_ID = process.env.PARTIAL_PAYMENT_TEMPLATE_ID!;
...
export const MEETING_SCHEDULED_TEMPLATE_ID = process.env.MEETING_SCHEDULED_TEMPLATE_ID!;
export const MEETING_REMINDER_TEMPLATE_ID = process.env.MEETING_REMINDER_TEMPLATE_ID!;
export const MEETING_CANCELLED_TEMPLATE_ID = process.env.MEETING_CANCELLED_TEMPLATE_ID!;
export const MEETING_UPDATE_TEMPLATE_ID = process.env.MEETING_UPDATE_TEMPLATE_ID!;


export const MEMBERSHIP_EXPIRY_REMAINDER_TEMPLATE_ID = process.env.MEMBERSHIP_EXPIRY_REMAINDER_TEMPLATE_ID!;
export const MEMBERSHIP_EXPIRED_NOTIFICATION_TEMPLATE_ID = process.env.MEMBERSHIP_EXPIRED_NOTIFICATION_TEMPLATE_ID!;
